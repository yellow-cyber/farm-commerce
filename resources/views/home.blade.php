            ...
            <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                <nav>
                    <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                        <li><router-link class="inline-block no-underline hover:text-black hover:underline py-2 px-4" to="/shop">Shop</router-link></li>
                        <li><router-link class="inline-block no-underline hover:text-black hover:underline py-2 px-4" to="/about">About</router-link></li>
                        <li><router-link class="inline-block no-underline hover:text-black hover:underline py-2 px-4" to="/contact">Contact</router-link></li>
                    </ul>
                </nav>
            </div>
...
<section class="w-full mx-auto bg-nordic-gray-light flex pt-12 md:pt-0 md:items-center bg-cover bg-right" style="max-width:1600px; height: 32rem; background-image: url('{{asset('images/cover/horse.jpg')}}');">
