<template>
  <div class="container">
    <div class="flex flex-col mt-4">
      <div class="row pb-3">
        <div class="h5 font-weight-bold col-6 pt-3">Manage Products</div>
      ...
      <div class="-my-2 py-2 overflow-x-scroll scrolling-touch sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <div
          class="align-middle inline-block scrolling-touch min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200"
        >
          <table class="min-w-full">
            <thead>
              <tr>
                <th
                  class="pl-3 py-3 border-b border-gray-200 bg-gray-50 text-center text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider"
                >Name</th>
                <th
            ...
            <tbody class="bg-white">
              <tr v-for="model in models" :key="model.id">
                <td class="pl-3 py-3 text-center whitespace-no-wrap border-b border-gray-200">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <div class="text-sm text-left leading-5 text-gray-500">Item #{{ model.id }}</div>
                    </div>
                  </div>
                </td>
                <td
                  class="px-0 py-3 text-center whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500"
                >{{ model.created_at | prettyDate }}</td>
                ...
                <td
                  class="px-0 py-3 text-center whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-500"
                >{{ model.desc | prettyDescription }}</td>

                <td
                  class="px-0 py-3 text-center whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-medium"
                >
                  <svg
                ...
                <td
                  class="px-0 py-3 text-center whitespace-no-wrap border-b text-center border-gray-200 text-sm leading-5 font-medium"
                >
                  <svg
                    @click="deleteModel(model.id)"
                    class="bi fill-red mr-auto ml-auto text-center bi-trash cursor-pointer transition duration-500 ease-in-out hover:fill-red transform hover:scale-150"
                    width="2em"
                    height="1.3em"
                    viewBox="0 0 16 16"
                    fill="red"
