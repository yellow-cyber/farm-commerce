<template>
    <div>
        ...
        >
            <!-- container -->
            <div
                class="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto items-center"
            >
                <!-- hero wrapper -->
                <div
                ...
                >
                    ...
                    <div class="hero-text col-span-6">
                        ...
                        >
                            40% off Farm Supplies
                        </h1>
                        <hr class="w-12 h-1 bg-orange-500 rounded-full mt-8" />
                        <p
                            class="text-white text-base leading-relaxed mt-8 font-semibold"
                        >
        ...
        <section class="bg-white py-8">
            ...
            >
                ...
                >
                    <div
                        class="max-w-xs bg-white-100 shadow rounded-lg overflow-hidden my-10"
                    >
                        <div class="px-4 py-2">
                            <h1
                                class="text-gray-900 font-bold text-3xl uppercase"
                            >
                                {{ model.name }}
                            </h1>
